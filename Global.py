...
def yeap():
    ...
    goal.trajectory.points.append(JointTrajectoryPoint(time_from_start = Duration(0.40000), positions = [-0.0,-0.01538]))
    goal.trajectory.points.append(JointTrajectoryPoint(time_from_start = Duration(1.20000), positions = [-0.0,-0.80079]))
    goal.trajectory.points.append(JointTrajectoryPoint(time_from_start = Duration(2.40000), positions = [-0.0,0.68566]))
    goal.trajectory.points.append(JointTrajectoryPoint(time_from_start = Duration(3.44000), positions = [-0.0,-0.70875]))
    goal.trajectory.points.append(JointTrajectoryPoint(time_from_start = Duration(4.40000), positions = [-0.0,-0.01385]))
...
def main():
    ...
    action = input("Veuillez entrer le numero de l'action a realiser :\n")
